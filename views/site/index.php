                ...
                <div class="hero__outer-wrapper">
                    <div class="hero__inner-wrapper align-middle">
                        <h1>
                            ...
                            <a class="hero__title text-carousel" href="#contact" >Проконсультируйтесь, Получите информацию о ВСЕХ объектах</a>
                            <br>
                            ...
                            <div class="box__wrapper">
                                ...
                                <div class="box__content">
                                    <p style="font-size: 1.5rem;">
                                        Не секрет, что происходит с недвижимостью должников, невыплачивающих ипотеку. Иногда люди берут непосильную для себя ношу в виде кредита, под залог недвижимости. Банк забирает недвижимость у заемщика, невыполнившего свои обязательства, и, так как банк на прямую не занимается продажей недвижимости, он выставляет ее на аукцион.   </p>
                                </div>
                                <!--end box__content-->
                            </div>
                            <!--end box__wrapper-->
                    ...
                    <div class="col-md-4">
                        <div class="box">
                            <div class="box__wrapper">
                                ...
                                <div class="box__content">
                                    <p style="font-size: 1.5rem;">
                                        Мы оказываем информирование по объектам, полное сопровождение в ходе торгов, гарантируем выигрыш объекта на аукционе по привлекательной цене, осуществляем подготовку всех документов и получение права собственности.
                                    </p>
                                </div>
                            </div>
                        </div>
...
<!--                                    </h3>-->
                                    <h5>Старый петровско-Разумовский пр-д, д 3, кВ 67
                                        47,2 кв м
                                        5 500 000 (предварительная оценка 9 500 000)</h5>
<!--                                    <h3 class="reveal">Bathroom Refresh</h3>-->
                                </div>
                                <div class="img-into-bg">
                                    <img src="../../web/img/qwer.jpg" alt="">
                                </div>
                            </a>
                            <!--end gallery__image-->
                        </div>
                        <!--end col-md-4-->
                        <div class="col-md-4">
                            <a href="../../web/img/asdf.jpg" class="gallery__image popup-image">
                                <div class="gallery__caption">
                                    <h5>волгоградский проезд, д 113/3, кВ.1
                                        31,9 кв м
                                        3 100 000 (предварительно 5 800 000) </h5>
<!--                                    <h3 class="reveal">Hills Apartment</h3>-->
                                </div>
                                <div class="img-into-bg">
                                    <img src="../../web/img/asdf.jpg" alt="">
                                </div>
                            </a>
                            <!--end gallery__image-->
                        </div>
                        <!--end col-md-4-->
                        <div class="col-md-4">
                            <a href="../../web/img/zxcv.jpg" class="gallery__image popup-image">
                                <div class="gallery__caption">
                                    <h5>Ленинский проспект, д 35, кв72
                                        72,9 кв м
                                        12 700 000 (предварительная оценка 20 000 000) </h5>
<!--                                    <h3 class="reveal">Story Restaurant</h3>-->
                                </div>
                                <div class="img-into-bg">
                                    <img src="../../web/img/zxcv.jpg" alt="">
                                </div>
                            </a>
                            <!--end gallery__image-->
                        </div>
                        <!--end col-md-4-->
                        <div class="col-md-4">
                            <a href="../../web/img/1232.jpg" class="gallery__image popup-image">
                                <div class="gallery__caption">
                                    <h5>Улица смольная, д 39, кВ 4
                                        31,9 кв м
                                        2 700 000 (предварительная оценка 6 000 000) </h5>
<!--                                    <h3 class="reveal">Room Furniture</h3>-->
                                </div>
                                <div class="img-into-bg">
                                    <img src="../../web/img/1232.jpg" alt="">
                                </div>
                            </a>
                            <!--end gallery__image-->
                        </div>
                        <!--end col-md-4-->
                        <div class="col-md-4">
                            <a href="../../web/img/1233.jpg" class="gallery__image popup-image">
                                <div class="gallery__caption">
                                    <h5>Филевский б-р, д 21,кв 106
                                        52,1 кв м
                                        6 500 000 (предварительная оценка 9 540 000) </h5>
<!--                                    <h3 class="reveal">Maracana Cups</h3>-->
                                </div>
                                <div class="img-into-bg">
                                    <img src="../../web/img/1233.jpg" alt="">
                                </div>
                            </a>
                            <!--end gallery__image-->
                        </div>
                        <!--end col-md-4-->
                        <div class="col-md-4">
                            <a href="../../web/img/1234.jpg" class="gallery__image popup-image">
                                <div class="gallery__caption">
                                    <h5>Старая басманная, д 9/2, кВ 6
                                        38,3 кв м
                                        6 600 000 (предварительная оценка 13 200 000) </h5>
            ...
            <div class="container">
                <div class="block__wrapper">
                    ...
                    <div class="row">
                        <div class="col-md-7">
                            <p style="font-size: 1.5rem;">
                                Мы предлагаем поучаствовать в торгах и сильно сэкономить на покупке недвижимости, как коммерческой, так и жилой.<br>
                                Алгоритм действий таков:<br>
                                - При личной встрече в офисе просматриваем список актуальных объектов недвижимости и подбираем вам наиболее подходящий лот.<br>
                                - Регистрируем заявку на участие в аукционе. Собираем пакет документов и оплачиваем пошлину.<br>
                                - Выигрываем аукцион. Получаем право собственности на объект.<br>
                                <br>
                                По срокам всех процедур, ценам на объекты и другим вопросам расскажем при консультации. Оставьте заявку на звонок!
                            </p>
                            ...
                            <div style="font-size: 1.5rem" class="col-sm-6 col-lg-12">
                                ...
                                <div class="py-4">
                                    <figure>
                                        ...
                                        <a href="#">flauersr@inbox.ru </a>
                                    </figure>
                                    <figure>
                                        <i class="fa fa-phone width-20px"></i>
                                        <a href="#">+7(925)685-39-71</a>
                                    </figure>
<!--                                    <figure>-->
